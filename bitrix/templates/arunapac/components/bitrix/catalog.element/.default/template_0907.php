...
?><div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		<div class="row">
                	<div class="col-md-6 col-sm-12 backgroung-image">
...
<img src="<?=$photo['SRC']?>" alt="<?=$alt?>" title="<?=$title?>"<?=($key == 0 ? ' itemprop="1image"' : '')?>>
		...
		<div class="product-item-detail-aruna">
								<?
...
<div class="schema-img-object" tabindex="0">
<div class="" >
  <img src="<?echo CFile::GetPath($arResult["PROPERTIES"]["SCHEMA"]["VALUE"]);?>" />
</div></div>
</div>
...
<?
unset($actualItem, $itemIds, $jsParams);<?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>