...
<?$APPLICATION->IncludeComponent("bitrix:news", "aruna-catalog-vakansii", Array(
	"ADD_ELEMENT_CHAIN" => "Y",	// Включать название элемента в цепочку навигации
		...
		"IBLOCK_TYPE" => "vakansii",	// Тип инфоблока
		...
		"SEF_FOLDER" => "/vakansii/",	// Каталог ЧПУ (относительно корня сайта)
		...
		"COMPONENT_TEMPLATE" => "aruna-catalog-vakansii",
